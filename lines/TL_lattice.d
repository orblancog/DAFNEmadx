...
TL3: line=(BPSTL002,D9B,WCMTL001,D9A,QUATL005,QUATL005,D8C,CHVTL003,D8B,FL2TL002,D8A);

TL2: line=(D7,QUATL004,QUATL004,D6B,CHVTL002,D6A,QUATL003,QUATL003,D5B,SIPTL001,D5A,
	   QUATL002,QUATL002,D4B,
           BPSTL001,CHVTL001,D4A);

TL1: line= (D3,QUATL001,QUATL001,D2B,FL2TL001,D2A);
...
TT5: line = (KER5,FL1TT002,D21A,CHVTT007,D21B,QUATT008,QUATT008,BPSTT006,D22,WCMTT002);

TT6: line = (KER1,D23A,D23B,QUATT009,QUATT009,D23C,BPSTT007,D24);

TT7: line = (KER2,D25A,CHVTT009,D25B,
     	     !BPSTT008, BPS removed from model because it is installed but not used
	     D25C,
...
! TP;
 tp1  : line = (D27A,BPSTP001,D27B,QUATP001,QUATP001,D28A,CHVTP001,D28B,!
      	       !mqtp02,??? what is this ???
                QUATP002,QUATP002,FL1TP001,D29A,CHVTP002,D29B,
		!Mqtp03,
		QUATP003,QUATP003,D30);
 tp2  : line = (D31A,CHVTP003,D31B,QUATP004,QUATP004,D32A,BPSTP002,FL1TP002,D32B,WCMTP001); 
...
! accum -> dafne
 p_ae : line = (-ASPTein,-TLLINE,mDHYTT001,TTLINE,
               tp1, mDHRTP002,tp2,p_SPT,FL1PL101);
