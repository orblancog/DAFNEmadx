...
#without error bars
p 'TLe_20170221122201_REFORB_15mA_inACC_dispersione.dat' u 1:3 w lp lt 6 lw 6 ti 'TLe 20170221122201 REFORB 15mA inACC dispersione, absolute', \
  '< paste TLe_20170221122344_662M667_dispersione.dat' u 1:3 w lp lt 7 lw 6 ti 'TLe 20170221122344 662M667 dispersione, relative', \
  0 lw 3 lt -1 dashtype 2 ti '', \
  '< grep -i BPS* tle_ae.tls' u (column(col_s)):(column(col_dy)*(neoffset*eoffset*1e3)) w lp lt 7 lw 3 dashtype 2
