...
int DrawPhaseSpaceAper (const char * k, const int giro=-2) {//k is the flag name , giro is the turn number
  // if giro =-2 print all turns
  ...
  trackfl->Append(k);
  TH2 * trackxpx = new TH2F("H. Phase Space","H Phase Space",61,-50,50,81,-40,40);//number,-x,x,number,-y,y
